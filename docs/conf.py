# -*- coding: utf-8 -*-
#
# gIRClib documentation build configuration file, created by
...
html_use_opensearch = 'http://girclib.algarvio.me/'

# This is the file name suffix for HTML files (e.g. ".xhtml").
#html_file_suffix = None

# Output file base name for HTML help builder.
htmlhelp_basename = 'gIRClibDoc'
...
latex_documents = [
  ('index', 'gIRClib.tex', u'gIRClib Documentation',
...
man_pages = [
    ('index', 'girclib', u'gIRClib Documentation',
     [u'Pedro Algarvio'], 1)
]
