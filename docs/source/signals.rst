...
built-in decorators do (eg: :data:`~flask.request_started` is very similar
...
are helpful for unittesting for example.  Say you want to know what templates
were rendered as part of a request: signals allow you to do exactly that.
...
.. autofunction:: on_nick_changed(emitter, nickname=None)
