# -*- coding: utf-8 -*-
#
# IRCLibLet documentation build configuration file, created by
...
project = u'IRCLibLet'
copyright = u'2011, Pedro Algarvio'
...
# of the sidebar.
html_logo = '_static/ircliblet.png'
...
htmlhelp_basename = 'IRCLibLetdoc'
...
latex_documents = [
  ('index', 'IRCLibLet.tex', u'IRCLibLet Documentation',
...
man_pages = [
    ('index', 'ircliblet', u'IRCLibLet Documentation',
     [u'Pedro Algarvio'], 1)
]
...
#    http://www.rfk.id.au/software/pyenchant/tutorial.html>
spelling_word_list_filename = os.path.join(os.path.dirname(__file__),
